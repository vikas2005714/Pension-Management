...
using PensionerDetailMicroservice.AutoMapper;
...
namespace PensionerDetailMicroservice
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IPensionDetails,PensionRepository>();
            services.AddAutoMapper(typeof(PensionDetailsMapper));
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ProcessPensionMicroservice", Version = "v1" });
